/*
Project:  Edis Techlab Garten-Wemos Pro with MQTT and Display inlcuding a Si7021 Sensor, controlled from a Server
...
// Diverse Variablen
const int sensorTaktSek = 10;   // alle x Sekunden werden die Sensoren ausgelesen
int btnState = LOW;
int waterState = HIGH;
int errorState = LOW;
long lastMsg = 0;
